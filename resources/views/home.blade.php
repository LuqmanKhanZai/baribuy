...
<div class="row">
    <div class="col-lg-3">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <span class="label label-success pull-right">{{$total_user}}</span>
                <h5>Total Users</h5>
            </div>
            <div class="ibox-content">
                <h1 class="no-margins">{{$total_country}}</h1>
    ...
    <div class="col-lg-3">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <span class="label label-info pull-right">{{$total_customer}}</span>
                <h5>Total Customers</h5>
            </div>
            <div class="ibox-content">
                <h1 class="no-margins">{{$total_state}}</h1>
                {{-- <div class="stat-percent font-bold text-info">20% <i class="fa fa-level-up"></i></div> --}}
                <small>Total State</small>
            </div>
        </div>
    </div>
    <div class="col-lg-3">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <span class="label label-primary pull-right">{{$total_property}}</span>
                <h5>Total Property</h5>
            </div>
            <div class="ibox-content">
                <h1 class="no-margins">{{$total_category}}</h1>
    ...
    <div class="col-lg-3">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <span class="label label-danger pull-right">{{$total_city}}</span>
                <h5>Total City</h5>
            </div>
            <div class="ibox-content">
                <h1 class="no-margins">423</h1>
